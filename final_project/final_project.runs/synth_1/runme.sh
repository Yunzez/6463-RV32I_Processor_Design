...
HD_PWD='C:/Users/frezy/NYU-6463-RV32I_Processor_Design/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Instruction_decode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Instruction_decode.tcl
