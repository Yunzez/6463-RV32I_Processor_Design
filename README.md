...
## You can also checkout the bitstream file that is generated specifically for *BASYS3 Artix-7 FPGA (XC7A35T-ICPG236C)* [Here](main\final_project\final_project.runs\impl_1\Board.bit) at path *final_project\final_project.runs\impl_1\Board.bit*
